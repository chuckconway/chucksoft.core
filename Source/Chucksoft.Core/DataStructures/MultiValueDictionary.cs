...
namespace Chucksoft.Core.DataStructures
{
    /// <summary>
    ...
    public class MultiValueDictionary<TKey, TValue> : Dictionary<TKey, HashSet<TValue>>
    {
        ...
        private static void CantBeNull(TKey key, string keyName)
        {
// ReSharper disable CompareNonConstrainedGenericWithNull
            if (!key.GetType().IsValueType && key == null)
// ReSharper restore CompareNonConstrainedGenericWithNull
            {
                throw new ArgumentNullException(keyName, "Key can not be null");
            }
        }
